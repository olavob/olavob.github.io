...
type: "post"
tags: ['rant', 'archlinux', 'linux', 'aprendizado', 'instalação', 'tutorial', 'computer-science', 'sistemas-operacionais', 'guia',  'windows', 'wsl']
layout: default
comments: true
---

# WSL2: Setup para Dev no Windows, Configurando e Instalando Arch Linux
